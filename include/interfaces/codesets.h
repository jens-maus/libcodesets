...
struct CodesetsIFace
{
	...
	struct codeset * APICALL (*CodesetsSetDefaultA)(struct CodesetsIFace *Self, CONST_STRPTR name, struct TagItem * attrs);
	struct codeset * APICALL (*CodesetsSetDefault)(struct CodesetsIFace *Self, CONST_STRPTR name, ...);
	...
	struct codeset * APICALL (*CodesetsFindA)(struct CodesetsIFace *Self, CONST_STRPTR name, struct TagItem * attrs);
	struct codeset * APICALL (*CodesetsFind)(struct CodesetsIFace *Self, CONST_STRPTR name, ...);
	...
	ULONG APICALL (*CodesetsStrLenA)(struct CodesetsIFace *Self, CONST_STRPTR str, struct TagItem * attrs);
	ULONG APICALL (*CodesetsStrLen)(struct CodesetsIFace *Self, CONST_STRPTR str, ...);
	BOOL APICALL (*CodesetsIsValidUTF8)(struct CodesetsIFace *Self, CONST_STRPTR str);
